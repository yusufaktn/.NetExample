        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tbl_CategoryCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Categories_Tbl_CategoryCategoryId",
                        column: x => x.Tbl_CategoryCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedToUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieSuggestions", x => x.SuggestionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieSuggestions_Users_SuggestedByUserId",
                        column: x => x.SuggestedByUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovieSuggestions_Users_SuggestedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieSuggestions_SuggestedByUserId",
                table: "MovieSuggestions",
                column: "SuggestedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieSuggestions_SuggestedToUserId",
                table: "MovieSuggestions",
                column: "SuggestedToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_Tbl_CategoryCategoryId",
                table: "Users",
                column: "Tbl_CategoryCategoryId");
        }
